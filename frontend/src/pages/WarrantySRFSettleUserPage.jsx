...
const WarrantySettleSRFUserPage = () => {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      await updateWarrantySRFSettled(payload);
      setError({
  ...
  return (
    ...
    >
      <Typography
        ...
        sx={{ mb: 1 }}
      >
        Warranty Propose For SRF Settlement
      </Typography>
      <Box
        display="flex"
...
export default WarrantySettleSRFUserPage;
