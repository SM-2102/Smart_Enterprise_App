...
import { UploadComplaintNumber } from "../services/complaintNumberUploadService";

const ComplaintNumberUploadPage = () => {
  ...
  const handleUpload = async () => {
    ...
    setUploading(true);
    try {
      const res = await UploadComplaintNumber(file);
      setError({
        message: res.message,
...
export default ComplaintNumberUploadPage;
