...
import { fetchLastVendorChallanCode } from "../services/vendorChallanLastCodeService";
import { printVendor } from "../services/vendorChallanPrintService";

const VendorPrintPage = () => {
  ...
  useEffect(() => {
    async function loadLastChallanNumber() {
      try {
        const data = await fetchLastVendorChallanCode();
          ...
          <div className="flex items-center gap-2">
            ...
            <IconButton
              ...
              onClick={async (e) => {
                ...
                try {
                  const blob = await printVendor(challanNumber);
...
export default VendorPrintPage;
