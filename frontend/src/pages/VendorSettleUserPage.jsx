...
const SettleVendorUserPage = () => {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      await updateVendorSettled(payload);
      setError({
  ...
  const totalvendor_cost = data.reduce(
    (sum, row) => sum + (Number(row.vendor_cost) || 0),
    0,
  );
  const selectedvendor_cost = selectedRows.reduce(
      ...
      >
        <Box display="flex" alignItems="center">
          ...
          >
            ...
            <span style={{ color: "#0d47a1", fontWeight: 600 }}>
              ₹{" "}
              {totalvendor_cost.toLocaleString(undefined, {
        ...
        <Box display="flex" alignItems="center">
          ...
          >
            ...
            <span style={{ color: "#0d47a1", fontWeight: 600 }}>
              ₹{" "}
              {selectedvendor_cost.toLocaleString(undefined, {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2,
              })}
            </span>
...
export default SettleVendorUserPage;
