...
import { fetchNextChallanNumber } from "../services/roadChallanSmartNextCodeService";
import { FiSearch } from "react-icons/fi";
import { createRoadChallan } from "../services/roadChallanSmartCreateService";
...
const RoadChallanSmartCreatePage = () => {
    ...
    <div className="flex min-h-[80vh] mt-6 justify-center items-center">
      ...
      >
        <h2 className="text-xl font-semibold text-blue-800 mb-4 pb-2 border-b border-blue-500 justify-center flex items-center gap-2">
          Create Smart Enterprise Road Challan
        </h2>
...
export default RoadChallanSmartCreatePage;
