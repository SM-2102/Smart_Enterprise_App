...
import { fetchLastChallanNumber } from "../services/roadChallanUniqueLastCodeService";
import { printRoadChallan } from "../services/roadChallanUniquePrintService";

const RoadChallanUniquePrintPage = () => {
    ...
    <Container maxWidth="xs" sx={{ mt: 20 }}>
      ...
      >
        <h2 className="text-xl font-semibold text-blue-800 mb-4 pb-2 border-b border-blue-500 justify-center flex items-center gap-2">
          Print Unique Services Road Challan
        </h2>
...
export default RoadChallanUniquePrintPage;
